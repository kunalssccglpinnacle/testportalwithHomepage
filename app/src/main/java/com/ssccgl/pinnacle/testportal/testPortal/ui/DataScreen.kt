                        ...
                        if (currentQuestion != null) {
                            ...
                            Column(
                                ...
                                LazyColumn(
                                    ...
                                    item {
                                        // Updated to use hindi_question or english que


                                        HtmlText(html = currentQuestion.question)
                                        HtmlText(html = currentQuestion.hindi_question)
                                        Spacer(modifier = Modifier.height(16.dp))
...
@Composable
fun OptionItem(option: String, optionValue: String, selectedOption: String, onSelectOption: (String) -> Unit) {
    val borderColor = if (selectedOption == optionValue) Color.Blue else  Color.Transparent    //MaterialTheme.colorScheme.onSurface.copy(alpha = 0.5f)
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .padding(vertical = 4.dp)
...
private val additionalTouchPadding = PaddingValues(16.dp) // Adjust the padding as needed
